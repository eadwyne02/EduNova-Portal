  ...
  return (
    <div className="relative flex flex-col gap-2">
      ...
      <button
        ...
        className="flex items-center justify-between border border-black/15 rounded-lg px-4 py-3 text-sm text-left focus:outline-none hover:border-black/25 transition-colors"
      >
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-black/10 rounded-lg shadow-lg overflow-hidden z-20">
          {options.map((opt, i) => (
            <button
              ...
              className="w-full text-left px-4 py-2.5 text-sm text-black/75 hover:bg-black/[0.03] transition-colors"
            >
              {opt}
            </button>
          ))}
        ...
        {hasPending ? (
          <>
            ...
            <button
              ...
              className="text-sm text-[#1E3A8A] hover:underline w-fit"
            >
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-black/5 p-6">
              ...
              <textarea
                ...
                placeholder="I am requesting to transfer to the Computer Science programme because..."
                className="w-full border border-black/15 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#1E3A8A] transition-colors resize-none"
              />
            </div>
              ...
              <div className="flex flex-col gap-3">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={() => setAgreeAccurate(!agreeAccurate)}
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={() => setAgreeNoGuarantee(!agreeNoGuarantee)}
                    className="w-4 h-4 mt-0.5 rounded border-black/20 accent-[#1E3A8A]"
                  />
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
              ...
              <button
                ...
                disabled={!canSubmit}
                className="px-6 py-3 rounded-xl text-sm font-semibold text-white bg-[#14263F] hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 disabled:opacity-40 disabled:hover:translate-y-0 disabled:hover:shadow-none order-1 sm:order-3"
              >
                Submit Request
              </button>
            </div>
